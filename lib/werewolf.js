...
async function pagi(kayydev, x, data) {
  ...
  return await kayydev.sendMessage(x.room, {
    text: pagii(x),
    contextInfo: {
      externalAdReply: {
...
async function voting(kayydev, x, data) {
  let row = [];
  let ment = [];
...
async function malam(kayydev, x, data) {
...
async function skill(kayydev, x, data) {
  skillOn(x.room, data)
    ...
    for (let i = 0; i < x.player.length; i++) {
      if (x.player[i].role === "werewolf") {
        if (x.player[i].isdead != true) {
          ...
          await kayydev.sendMessage(x.player[i].id, {
            text: textnya,
            mentions: membernya,
          });
        }
...
async function win(x, t, kayydev, data) {
  ...
  if (getWinner(x.room, data).status === false || x.iswin === false) {
    ...
    return await kayydev.sendMessage(sesinya, {
      text: textnya,
      contextInfo: {
        externalAdReply: {
          title: "W E R E W O L F",
...
// playing
async function run(kayydev, id, data) {
  while (getWinner(id, data).status === null) {
    if (getWinner(id, data).status != null) {
      win(getWinner(id, data), 1, kayydev, data);
      break;
    } else {
      await sleep(90000);
    }
    if (getWinner(id, data).status != null) {
      ...
      await pagi(kayydev, sesi(id, data), data);
    }
    if (getWinner(id, data).status != null) {
      win(getWinner(id, data), 1, kayydev, data);
      break;
    ...
    if (getWinner(id, data).status != null) {
      ...
      await voting(kayydev, sesi(id, data), data);
    }
    if (getWinner(id, data).status != null) {
      win(getWinner(id, data), 1, kayydev, data);
      break;
    ...
    if (getWinner(id, data).status != null) {
      ...
      await malam(kayydev, sesi(id, data), data);
    }
    if (getWinner(id, data).status != null) {
      win(getWinner(id, data), 1, kayydev, data);
      break;
    } else {
      await skill(kayydev, sesi(id, data), data);
    }
    if (getWinner(id, data).status != null) break;
  }
  await win(sesi(id, data), 1, kayydev, data);
}

async function run_vote(kayydev, id, data) {
  while (getWinner(id, data).status === null) {
    if (getWinner(id, data).status != null) {
      win(getWinner(id, data), 1, kayydev, data);
      break;
...
async function run_malam(kayydev, id, data) {
  while (getWinner(id, data).status === null) {
    if (getWinner(id, data).status != null) {
      win(getWinner(id, data), 1, kayydev, data);
      break;
...
async function run_pagi(kayydev, id, data) {
  while (getWinner(id, data).status === null) {
    if (getWinner(id, data).status != null) {
      win(getWinner(id, data), 1, kayydev, data);
      break;
